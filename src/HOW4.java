...
public class HOW4 {
    ...
    public static String convert(String money) {
        ...
        //先添加人民币
        res.append("人民币");
        String[] moneyForConvert = money.split("\\.");    //分成两部分整数部分和小数部分
        res.append(convertBig(moneyForConvert[0]));    //  分别处理小数还有整数部分
    ...
    public static String readNum(String s) {
        ...
        if (resNum.charAt(resNum.length() - 1) == '零') resNum = resNum.substring(0, resNum.length() - 1);
        return resNum;
    }
    ...
    public static void main(String[] args) {
        ...
        Double money = Double.valueOf(in.nextLine());   //用double 以防输入的数字是0开头的
